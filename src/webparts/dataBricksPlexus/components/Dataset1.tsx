...
const DATASET_FETCH_URL = 'https://vivagoals-qa.analytics.crohnscolitisfoundation.org/vivagoals/show/Databricks/masterTable/Dataset1/fetchData';

const DataSet1: React.FC = () => {
